 ...
 * @author Adam Lochno
 */
public class KolkoKrzyzyk_szablon extends javax.swing.JFrame {

    private String Start = "X"; //Rozpoczynamy wpisywanie od X
    private int xLiczenie = 0;  //wartość początkowa wynosi ZERO
    private int oLiczenie = 0;  //wartość początkowa wynosi ZERO
    /**
     * Creates new form KolkoKrzyzyk_szablon
     */
    public KolkoKrzyzyk_szablon() {
        initComponents();
        setSize(850,400);
        setLocationRelativeTo(null);
    }
//Metoda służąca do zliczanie punktów graczy
  private void LiczeniePunktow()
  {
    PunktGraczX.setText(String.valueOf(xLiczenie));
    PunktGraczO.setText(String.valueOf(oLiczenie));
    }
  private void WybierzGracza()
  {
    ...
    private void WarunkiZwyciestwa()
    {
        ...
        if (b1 == ("X") && b2 == ("X") && b3 == ("X"))
        {
            JOptionPane.showMessageDialog(this, "Gracz X wygrywa", "Niepotrzebna wiadomość w nagłóku", 
        ...
        if (b1 == ("O") && b2 == ("O") && b3 == ("O"))
        {
            JOptionPane.showMessageDialog(this, "Gracz O wygrywa", "Niepotrzebna wiadomość w nagłóku", 
            JOptionPane.INFORMATION_MESSAGE);
            oLiczenie++;
            LiczeniePunktow();
            jButton1.setBackground(Color.yellow);
    ...
    private void initComponents() {
        ...
        PunktGraczX = new javax.swing.JLabel();
        ...
        PunktGraczO = new javax.swing.JLabel();
        ...
        PrzyciskEXIT = new javax.swing.JButton();
        ...
        PunktGraczX.setFont(new java.awt.Font("Times New Roman", 2, 36)); // NOI18N
        PunktGraczX.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanel7.add(PunktGraczX, java.awt.BorderLayout.CENTER);
        ...
        PunktGraczO.setFont(new java.awt.Font("Times New Roman", 2, 36)); // NOI18N
        PunktGraczO.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanel12.add(PunktGraczO, java.awt.BorderLayout.CENTER);
        ...
        PrzyciskRESET.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        ...
        jPanel16.add(PrzyciskRESET, java.awt.BorderLayout.CENTER);
        ...
        PrzyciskEXIT.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        PrzyciskEXIT.setText("EXIT");
        PrzyciskEXIT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PrzyciskEXITActionPerformed(evt);
            }
        });
        jPanel17.add(PrzyciskEXIT, java.awt.BorderLayout.CENTER);
    ...
    //PRZYCISK EXIT
    private void PrzyciskEXITActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrzyciskEXITActionPerformed
        frame = new JFrame ("EXIT");
        if (JOptionPane.showConfirmDialog(frame, "Potwierdź że chcesz opuścić tą wspaniałą grę", "Kółko i krzyżyk",
        JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION);
        {
            System.exit(0);
            
        }
    }//GEN-LAST:event_PrzyciskEXITActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    
       jButton1.setText(Start);     //WYWOŁANIE METODY Start, która wpisuje w okienko 
  
       //PONIŻSZE KOMENDY POWODUJĄ POKOLOROWANIE SIĘ TŁA I LITER W ZALEŻNOŚCI CO WPISZEMY
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KolkoKrzyzyk_szablon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KolkoKrzyzyk_szablon().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton PrzyciskEXIT;
    private javax.swing.JButton PrzyciskRESET;
    private javax.swing.JLabel PunktGraczO;
    private javax.swing.JLabel PunktGraczX;
